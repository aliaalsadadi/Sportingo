...
//document sidebar
var selector = '.document-sidebar .nav-link';
...
//summernote
$(document).ready(function() {
    $('.note-btn-group.btn-group').on('click', function() {
